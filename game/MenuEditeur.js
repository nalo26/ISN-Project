...
void MenuEditor() {
  AffEditeur();
  ctx.text = "10px Sans Serif";
  ctx.fillText("SHIFT=Print",450,515);
  ctx.fillText("ENTER=Switch",450,525);
  ctx.fillText("TAB=Save",450,535);
  ctx.fillText("TAB+SHIFT=Menu",450,545);
...
void AffEditeur () {//Affiche l'éditeur
  ...
  ctx.fillStyle = "rgb(45, 139, 97)";
  ctx.fillRect(0, 0, canvas.width, canvas.height);
  ctx.fillStyle = "rgb(0, 0, 0)";
  ctx.fillRect(0, 500, 500, 50);
  ctx.fillStyle = "rgb(200, 200, 200)";
  ctx.fillRect(0, 500, 500, 3);
